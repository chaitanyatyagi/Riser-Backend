...
router.post("/forget-password", [
    ...
    async (req, res, next) => {
        try {
            ...
            await sendMail(email, `<p>Please reset your password at this link - <a href="https://riser-frontend.vercel.app/reset-password?token=${token}">Click</a></p>`, "Reset Your Password",)
